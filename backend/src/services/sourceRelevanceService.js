export const SOURCE_RELEVANCE_RULES = [
  ...
  },
  {
    ...
    sourceKeys: ["koenig & bauer newsroom", "koenig-bauer.com/en/newsroom", "koenig-bauer.com/en/newsroom/press-releases"],
    rejectExactPaths: [
      "/en/newsroom",
    ...
    protectedPagePatterns: [
      "/en/newsroom/press-releases/article/",
    ],
    protectedInclude: [
      "banknote",
      "banknotes",
  ...
  {
    name: "ICAO TRIP",
    sourceKeys: ["icao trip", "icao.int/facilitation-programmes/assistance"],
    rejectPagePatterns: [
      "/icao.tv",
      "/social-media",
      "/strategic-goals/",
      "/finvest",
      "/corsia",
      "/state-action-plans-and-assistance",
      "/linkedin",
      "linkedin.com",
      "unitingaviation.com",
    ],
  ...
  },
  {
    ...
    sourceKeys: ["eu commission migration and home affairs news", "home-affairs.ec.europa.eu/news"],
    rejectExactPaths: [
      "/news",
      "/news_en",
    ],
  ...
  },
  {
    ...
    sourceKeys: ["europol newsroom", "europol.europa.eu/cms/api/rss/news"],
    include: [
  ...
  {
    name: "INTERPOL News",
    sourceKeys: ["interpol news", "interpol.int/en/news-and-events/news"],
    rejectExactPaths: [
  ...
  },
  {
    ...
    sourceKeys: ["tsa press releases", "tsa.gov/news/press/releases"],
    rejectExactPaths: [
      "/news/press/releases",
    ],
    include: [
    ...
    exclude: [
      "assaulting transportation security officers",
      "drug trafficking",
      "fifa",
      "state fair",
    ],
  },
  {
    ...
    sourceKeys: ["nist digital identity news", "nist.gov/news-events/news/rss.xml"],
    include: [
      "authentication",
      "biometric",
      "biometrics",
  ...
  {
    name: "ENISA News",
    sourceKeys: ["enisa news", "enisa.europa.eu/news"],
    rejectExactPaths: [
      "/news",
    ],
    include: [
  ...
  },
  {
    ...
    sourceKeys: ["openid foundation news", "openid.net/feed"],
    include: [
      "authentication",
      "credential",
      "digital identity",
  ...
  {
    name: "AAMVA News",
    sourceKeys: ["aamva news", "aamva.org/publications-news/aamva-news"],
    rejectExactPaths: ["/publications-news/aamva-news"],
    include: [
      "digital identity",
  ...
  },
  {
    ...
    rejectExactPaths: ["/en/policies/electronic-identification"],
    include: [
      "digital identity",
      "digital identity wallet",
      "eidas",
  ...
  },
  {
    ...
    sourceKeys: ["bank of canada news", "bankofcanada.ca/utility/news/feed"],
    include: [
      "bank note",
      "bank notes",
      "banknote",
  ...
  },
  {
    ...
    sourceKeys: ["bank of england news", "bankofengland.co.uk/rss/news"],
    include: [
      "banknote",
      "banknotes",
      "cash",
  ...
  },
  {
    ...
    sourceKeys: ["european central bank press releases", "ecb.europa.eu/rss/press.html"],
    include: [
      "banknote",
      "banknotes",
      "cash",
